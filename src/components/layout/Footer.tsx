...
const socialLinks = [
  ...
  {
    name: "Facebook",
    href: "https://web.facebook.com/people/Cryptoelectro-AU/61590304272310/",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
  ...
  {
    name: "Instagram",
    href: "https://www.instagram.com/cryptoelectro__au",
    icon: (
      <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
...
export default function Footer() {
  return (
    <footer className="bg-secondary-dark border-t border-secondary-light">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="col-span-2 lg:col-span-1">
            ...
            <p className="text-small text-text-primary/60 mb-6 leading-relaxed">
              Australia&apos;s premium electronics marketplace. Crypto and Credit Cards payments
              accepted.
            </p>
            {/* Social Links */}
            <div className="flex gap-3">
              {socialLinks.map((social) => (
                <a
                  key={social.name}
                  href={social.href}
                  className="p-2 text-text-primary/50 hover:text-accent transition-colors"
              ...
              <ul className="space-y-3">
                {section.links.map((link) => (
                  <li key={link.name}>
                    <Link
                      href={link.href}
                      className="text-small text-text-primary/60 hover:text-accent transition-colors"
                    >
                      {link.name}
                    </Link>
                  </li>
        ...
        {/* Bottom Bar */}
        <div className="mt-12 pt-8 border-t border-secondary-light flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-small text-text-primary/40">
            &copy; {new Date().getFullYear()} Cryptoelectro-au. All rights
            reserved.
          </p>
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="badge badge-accent text-xs">CARDS</span>
