...
export default function CategoryPage() {
    ...
    return (
      <div className="min-h-screen flex items-center justify-center">
        <div className="text-center">
          <h2 className="text-2xl font-heading font-bold">Category Not Found</h2>
          <p className="mt-2 text-text-primary/50">The category you are looking for does not exist.</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <Breadcrumb items={[{ label: "Categories", href: "/" }, { label: category.name }]} />

      <div className="mb-8">
        <h1 className="text-3xl lg:text-4xl font-heading font-bold">{category.name}</h1>
        {category.description && (
          <p className="mt-2 text-text-primary/50">{category.description}</p>
        )}
      </div>
        ...
        <div className="lg:col-span-3">
          ...
          {paginatedProducts.length > 0 ? (
            ...
            <div className="text-center py-16">
              ...
              <p className="text-text-primary/50">Try adjusting your filters or search criteria.</p>
            </div>
          )}
