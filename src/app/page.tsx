            ...
            {brands.map((brand: any) => (
              <Link key={brand.id} href={`/category/all?brand=${brand.slug}`} className="card flex flex-col items-center justify-center p-4 sm:p-6 gap-3 sm:gap-4 group min-h-[130px] sm:min-h-[150px] hover:border-accent/30 transition-all">
                <div className="w-16 h-10 sm:w-20 sm:h-12 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  ...
                  {brand.slug === "apple" && (<svg viewBox="0 0 24 24" className="w-8 h-8 sm:w-10 sm:h-10" fill="currentColor" style={{ color: "#000000" }}><path d="M18.71 19.5c-.83 1.24-1.71 2.45-3.05 2.47-1.34.03-1.77-.79-3.29-.79-1.53 0-2 .77-3.27.82-1.31.05-2.3-1.32-3.14-2.53C4.25 17 2.94 12.45 4.7 9.39c.87-1.52 2.43-2.48 4.12-2.51 1.28-.02 2.5.87 3.29.87.78 0 2.26-1.07 3.8-.91.65.03 2.47.26 3.64 1.98-.09.06-2.17 1.28-2.15 3.81.03 3.02 2.65 4.03 2.68 4.04-.03.07-.42 1.44-1.38 2.83M13 3.5c.73-.83 1.94-1.46 2.94-1.5.13 1.17-.34 2.35-1.04 3.19-.69.85-1.83 1.51-2.95 1.42-.15-1.15.41-2.35 1.05-3.11z"/></svg>)}
                  {brand.slug === "sony" && (<svg viewBox="0 0 80 24" className="w-full h-full" fill="currentColor" style={{ color: "#000000" }}><text x="0" y="20" fontFamily="Arial,sans-serif" fontSize="22" fontWeight="900">SONY</text></svg>)}
                  {brand.slug === "lg" && (<svg viewBox="0 0 48 24" className="w-full h-full" fill="currentColor" style={{ color: "#A50034" }}><circle cx="12" cy="12" r="11" fill="#A50034" /><text x="12" y="17" textAnchor="middle" fontFamily="Arial,sans-serif" fontSize="11" fontWeight="900" fill="#FFFFFF">LG</text></svg>)}
                  ...
                  {brand.slug === "nikon" && (<svg viewBox="0 0 100 24" className="w-full h-full"><rect x="2" y="2" width="96" height="20" rx="3" fill="#000000" /><text x="50" y="17" textAnchor="middle" fontFamily="Arial,sans-serif" fontSize="14" fontWeight="900" fill="#FFDE00">Nikon</text></svg>)}
                  {brand.slug === "dyson" && (<svg viewBox="0 0 80 24" className="w-full h-full" fill="currentColor" style={{ color: "#000000" }}><text x="0" y="20" fontFamily="Arial,sans-serif" fontSize="22" fontWeight="900">dyson</text></svg>)}
