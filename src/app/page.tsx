            ...
            {brands.map((brand: any) => (
              <Link key={brand.id} href={`/category/all?brand=${brand.slug}`} className="card flex flex-col items-center justify-center p-4 sm:p-6 gap-3 sm:gap-4 group min-h-[130px] sm:min-h-[150px] hover:border-accent/30 transition-all">
                <div className="w-16 h-10 sm:w-20 sm:h-12 flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
                  ...
                  {brand.slug === "lenovo" && (<svg viewBox="0 0 120 24" className="w-full h-full" fill="currentColor" style={{color:"#E2231A"}}><text x="0" y="20" fontFamily="Arial,sans-serif" fontSize="22" fontWeight="900">Lenovo</text></svg>)}
                  ...
                  {brand.slug === "nintendo" && (<svg viewBox="0 0 120 24" className="w-full h-full" fill="currentColor" style={{color:"#E60012"}}><text x="0" y="20" fontFamily="Arial,sans-serif" fontSize="22" fontWeight="900">NINTENDO</text></svg>)}
                </div>
